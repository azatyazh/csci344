...
def exercise3():
    ...
    #grab search_term and location form the query string:
    search_term = request.args.get('term')
    if search_term is None: 
        return '"term" is a required query parameter'
    location = request.args.get('location')
    if location is None:
        return '"location" is a required query parameter'
...
def exercise4():
    ...
    return render_template(
        ...
        user=current_user, 
        weekend_plans="sitting in my room, dodging noobs.", 
