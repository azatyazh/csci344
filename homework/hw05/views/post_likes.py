...
class PostLikesListEndpoint(Resource):
    ...
    def post(self):
        ...
        '''
        Error handelling 
        + liking same thing twice 
        + someone sends a post that doesn't excist 

        Goal create a new like in the database
        Get some data from the user:
            - post_id
            - user_id self.current_user.id
        Create a new like post object
        ...
        #check that we've not already liked it:
...
class PostLikesDetailEndpoint(Resource):
    ...
    def delete(self, id):
        ...
        #check if the user ownes the liked
